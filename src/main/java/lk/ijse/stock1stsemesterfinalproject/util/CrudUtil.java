package lk.ijse.stock1stsemesterfinalproject.util;
...
public class CrudUtil { // This class contains utility methods for executing CRUD operations (Create, Read, Update, Delete) with the database.
